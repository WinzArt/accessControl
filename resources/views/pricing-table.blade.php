			...
			<div class="page-content">
				...
				<div class="pricing-table">
					...
					<div class="row row-cols-1 row-cols-lg-3">
						<!-- Free Tier -->
						<div class="col">
							<div class="card mb-5 mb-lg-0 bg-primary">
								<div class="card-body">
									<h5 class="card-title grey-text text-uppercase text-center text-white">Free</h5>
									<h6 class="card-price text-center text-white">$0<span class="term">/month</span></h6>
									<hr class="my-4">
									<ul class="list-group list-group-flush">
										...
										<li class="list-group-item bg-transparent text-white"><i class='bx bx-x me-2 font-18'></i>Unlimited Private Projects</li>
										<li class="list-group-item bg-transparent text-white"><i class='bx bx-x me-2 font-18'></i>Dedicated Phone Support</li>
										<li class="list-group-item bg-transparent text-white"><i class='bx bx-x me-2 font-18'></i>Free Subdomain</li>
