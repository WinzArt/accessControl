					...
					<div class="email-list">
						...
						<a href="{{ url('app-emailread') }}">
							<div class="d-md-flex align-items-center email-message px-3 py-1">
								...
								<div class="">
									<p class="mb-0">Contrary to popular belief, Lorem Ipsum is not simply random text.
										It has roots in...</p>
								</div>
								<div class="ms-auto">
						...
						<a href="{{ url('app-emailread') }}">
							<div class="d-md-flex align-items-center email-message px-3 py-1">
								...
								<div class="">
									<p class="mb-0">Content here, content here', making it look like readable English...
									</p>
								</div>
								<div class="ms-auto">
