							...
							<div class="card-body">
								<div class="border p-3 rounded">
									<div class="text-center">
										<h3 class="">Sign Up</h3>
										<p>Already have an account? <a href="{{url('authentication-signin-with-header-footer')}}">Sign in
												here</a>
										</p>
									</div>
									<div class="d-grid">
										...
										{{-- <a href="javascript:;" class="btn btn-facebook shadow-sm btn-primary"><i
										...
										<form class="row g-3">
											...
											<div class="col-6">
												...
												<select class="form-select" id="inputSelectCountry" aria-label="Default select example">
													...
													<option value="1">Reseptionist</option>
